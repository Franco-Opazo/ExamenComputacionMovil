...
class CategoryService extends ChangeNotifier {
  ...
  Future editOrCreateCategory(ListadoCategorias category) async {
    isEditCreate = true;
    notifyListeners();
  ...
  Future createCategory(ListadoCategorias category) async {
    final url = Uri.http(
      _baseUrl,
  ...
  Future deleteCategory(ListadoCategorias category) async {
    final url = Uri.http(
      _baseUrl,
